...
// 4. 항등원 Identity - 임의의 수와의 연산 결과를 항상 동일한 수로 만들어주는 특별한 수
...
// 5. 역원 Inverse - 임의의 수와 연산결과를 항상 항등원으로 만들어주는 특별한 수
...
// 공리적 집합론에서 두 연산에 대해 11가지 공리를 모두 만족하는 수 집합은 체 Field의 구조
// 유리수와 실수와 같이 체의 구조를 가지는 수 집합은 덧셈 곱셈 안전
// 뺄셈과 나눗셈은 체의 구조를 못지님
// 그렇기에 뺄셈 대신 덧셈의 역원을 사용하고, 나눗셈 대신 곱셈의 역원 사용
